...
const {GETtargetView, getUsers,POSTNewTarget,GETdetailTarget,PUTKPIs,GETTerms} = require("../../controller/salesKPIsController/targetController");
...
router.get("/terms/by-department/:depId",GETTerms)
